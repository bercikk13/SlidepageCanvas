...
//            canvas.drawCircle(2*split-dpToPx( margin), height-dpToPx( margin), dpToPx( k*radius), paint);
//
//            if(k==0)
//
//            {
...
//            paint.setStyle(Paint.Style.FILL);
//            paint.setAlpha(newalpha);
//            canvas.drawCircle(split-dpToPx( margin), height-dpToPx( margin), dpToPx(reverse- k*radius), paint);
//
//
//        }else if (i==1)
//        {
//            paint.setStyle(Paint.Style.FILL);
//            paint.setAlpha(newalpha);
//            canvas.drawCircle(3*split-dpToPx( margin), height-dpToPx( margin), dpToPx( k*radius), paint);
//
//            if(k==0)
//
//            {
...
//            }
//            paint.setStyle(Paint.Style.FILL);
//            canvas.drawCircle(2*split-dpToPx( margin), height-dpToPx( margin), dpToPx(reverse- k*radius), paint);
//        }else if(i==2)
//        {
//            paint.setStyle(Paint.Style.FILL);
//            canvas.drawCircle(4*split-dpToPx( margin), height-dpToPx( margin), dpToPx( k*radius), paint);
//            if(k==0)
//
//            {
//                canvas.drawCircle(3*split-dpToPx( margin), height-dpToPx( margin), dpToPx( radius), paint);
...
//            }
//
//            canvas.drawCircle(3*split-dpToPx( margin), height-dpToPx( margin), dpToPx(reverse- k*radius), paint);
//        }else if (i==3)
//        {
//            paint.setStyle(Paint.Style.FILL);
//            canvas.drawCircle(5*split-dpToPx( margin), height-dpToPx( margin), dpToPx( k*radius), paint);
//            if(k==0)
//
//            {
//                canvas.drawCircle(4*split-dpToPx( margin), height-dpToPx( margin), dpToPx( radius), paint);
